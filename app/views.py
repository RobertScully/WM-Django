...
class UserProfile(UpdateView):
    ...
    @csrf_exempt
    def get_dublin_bikes(request):
        bikeFile = urllib2.urlopen(
            'https://api.jcdecaux.com/vls/v1/stations?contract=dublin&apiKey=fa2ba4355e396b61ee8afee9b365a18484cf0c64')
        bikeData = bikeFile.read()
        bikeFile.close()
        for item in bikeData:
            print(item)
        return Response(bikeData, status=200)
